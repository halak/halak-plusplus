#pragma once
#ifndef __HALAK_INSTANCEINFO_INL__
#define __HALAK_INSTANCEINFO_INL__
...
#   include <Halak/TypeLibrary.h>
    ...
    namespace Halak
    {
        ...
        {
            return InstanceInfo(TypeLibrary::GetInstance().GetType<T>(), MPL::GetPointerDepth<T>::Value, MPL::IsReference<T>::Value);
        }
    }
