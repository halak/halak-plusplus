...
namespace Halak
{
    ...
    {
        HKAssertDebug(defaultSwapChain == nullptr);
        HKAssertDebug(swapChains.empty());
    ...
    void GraphicsDevice::Add(DisplaySwapChain* item)
    {
        ...
        HKAssertDebug(std::find(swapChains.begin(), swapChains.end(), item) == swapChains.end());
    ...
    void GraphicsDevice::Remove(DisplaySwapChain* item)
    {
        ...
        HKAssertDebug(it != swapChains.end());
        swapChains.erase(it);
    }
}