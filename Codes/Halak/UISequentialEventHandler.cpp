#include <Halak/UISequentialEventHandler.h>
#include <algorithm>
...
namespace Halak
{
    ...
    {
        HKAssertDebug(0 <= index && index < static_cast<int>(handlers.size()));
    ...
    {
        HKAssertDebug(std::find(value.begin(), value.end(), nullptr) == value.end());
