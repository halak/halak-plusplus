#pragma once
#ifndef __HALAK_EVALUABLERANGESEQUENCETEMPLATE_INL__
#define __HALAK_EVALUABLERANGESEQUENCETEMPLATE_INL__
/**
#   include <cmath>
    ...
    namespace Halak
    {
        ...
        template <typename T> void EvaluableRangeSequenceTemplate<T>::UpdateValue()
        {
            ...
            const float clippedTime = GetLooped() ? std::fmodf(time, duration) : std::min(time, duration);
