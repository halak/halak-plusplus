...
namespace Halak
{
    ...
    unsigned short Math::Clamp(unsigned short value, unsigned short min, unsigned short max)
    {
        return value < min ? min : (value > max ? max : value);
    }
    ...
    unsigned int Math::Clamp(unsigned int value, unsigned int min, unsigned int max)
    {
        return value < min ? min : (value > max ? max : value);
    }
    ...
    unsigned long Math::Clamp(unsigned long value, unsigned long min, unsigned long max)
    {
        return value < min ? min : (value > max ? max : value);
    }
