#pragma once
#ifndef __HALAK_SIGNAL_INL__
#define __HALAK_SIGNAL_INL__
...
#   include <memory.h>
    ...
    namespace Halak
    {
        ...
        template <typename T> static T* SignalBase::Strip(shared_ptr<T> pointer)
        {
            return pointer.get();
        }

        template <typename T> static T* SignalBase::Strip(weak_ptr<T> pointer)
        {
